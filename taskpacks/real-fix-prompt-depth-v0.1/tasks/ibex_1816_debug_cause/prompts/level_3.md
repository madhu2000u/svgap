...
Cycle-exact contract: On enter_debug_i, latch debug_req_i. On a later save_cause_i, update cause_haltreq_o from that latched value, never from live debug_req_i.
