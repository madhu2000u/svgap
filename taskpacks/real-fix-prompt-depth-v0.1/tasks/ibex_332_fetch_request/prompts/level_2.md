...
Cycle-exact contract: If req_o&& !gnt_i is sampled on a rising edge, req_o must be 1 and addr_o must equal its previous value on every following stalled cycle.
