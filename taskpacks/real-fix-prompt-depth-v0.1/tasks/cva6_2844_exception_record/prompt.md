...
Cycle-exact contract: Combinational truth table: illegal_i=0 makes every output zero. illegal_i=1 sets valid_o=1,cause_o=2,tval_o=instr_i,htval_o=0,mtinst_o=0,gva_o=virt_i.
